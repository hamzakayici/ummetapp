...
export default function HakkimizdaPage() {
  return (
    <>
      ...
      <section className="cta-section"><h2>Ümmet&apos;i Keşfedin</h2><p>İslami yaşamınıza güç katın — ücretsiz indirin.</p><a href="https://apps.apple.com/tr/app/ummet/id6760871547" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: "inline-flex" }}>App Store&apos;dan İndir</a></section>
    </>
  );
}
