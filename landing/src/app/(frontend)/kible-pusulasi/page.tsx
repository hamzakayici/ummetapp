...
export default function KiblePusulasiPage() {
  return (
    <>
      ...
      <section className="cta-section"><h2>Kıble Yönünü Hemen Bulun</h2><p>Ümmet ile dünyada her yerden hassas kıble.</p><a href="https://apps.apple.com/tr/app/ummet/id6760871547" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: "inline-flex" }}>Ücretsiz İndir</a></section>
    </>
  );
}
