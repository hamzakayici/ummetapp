...
import { Rocket, BarChart3, Globe, Users, CheckCircle, Zap, Sparkles, Bell, Wifi } from "lucide-react";
...
const TIMELINE = [
  {
    ...
    items: [
      ...
      { text: "Delâilü'l-Hayrât okuma modülü", tag: "new" },
    ],
  },
  {
    ...
    version: "v1.0.1",
    icon: <Bell size={18} />,
    title: "Push Bildirim & Sosyal Zikir",
    status: "completed" as const,
    items: [
      { text: "Günlük ayet push bildirimi (Türkçe)", tag: "new" },
      { text: "Ortak Zikir — canlı zikir halkaları (Supabase)", tag: "new" },
      { text: "Cuma günü Kehf Suresi hatırlatıcısı", tag: "new" },
      { text: "Streak hatırlatıcı bildirimi", tag: "new" },
      { text: "Ruh hâli bazlı ayet önerileri", tag: "new" },
    ],
  },
  {
    date: "Nisan 2026",
    ...
    title: "Analitik & İçerik Yönetimi",
    status: "current" as const,
    items: [
      { text: "Admin panel entegrasyonu (içerik yönetimi)", tag: "coming" },
      { text: "Push bildirim yönetimi (admin panelden)", tag: "coming" },
