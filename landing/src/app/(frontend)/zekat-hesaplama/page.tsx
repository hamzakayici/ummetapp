...
export default function ZekatHesaplamaPage() {
  return (
    <>
      ...
      <section className="cta-section"><h2>Zekatınızı Kolayca Hesaplayın</h2><p>Ümmet ile nisap kontrolü ve detaylı hesaplama.</p><a href="https://apps.apple.com/tr/app/ummet/id6760871547" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: "inline-flex" }}>Ücretsiz İndir</a></section>
    </>
  );
}
