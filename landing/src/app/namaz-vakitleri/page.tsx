...
export default function NamazVakitleriPage() {
  return (
    <>
      ...
      <section className="cta-section"><h2>Namaz Vakitlerini Doğru Takip Edin</h2><p>Ümmet ile konumunuza göre hassas vakitler.</p><a href="/#download" className="btn-primary" style={{ display: "inline-flex" }}>Ücretsiz İndir</a></section>
    </>
  );
}
