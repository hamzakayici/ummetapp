...
const FEATURES = [
  { icon: "🕌", bg: "rgba(64,192,87,0.12)", title: "Namaz Vakitleri", desc: "Diyanet hesaplamasıyla konumunuza göre otomatik vakitler, güneş yayı animasyonu, ezan bildirimleri ve iOS Widget." },
  { icon: "📖", bg: "rgba(212,175,55,0.12)", title: "Kuran-ı Kerim", desc: "114 sure, Arapça metin, Türkçe meal, sure arama, okuma takibi ve yer imi kaydetme." },
  ...
  { icon: "📿", bg: "rgba(249,115,22,0.12)", title: "Dijital Tesbih", desc: "Zikir sayacı, hedef belirleme, streak takibi ve haptic geri bildirim." },
  { icon: "🧭", bg: "rgba(34,211,238,0.12)", title: "Kıble Pusulası", desc: "Sensör tabanlı hassas kıble yönü, derece göstergesi ve Kabe mesafesi." },
  { icon: "🌙", bg: "rgba(240,208,96,0.12)", title: "Hicri Takvim", desc: "Miladi-Hicri dönüştürme, mübarek geceler, kandiller ve önemli İslami günler." },
  { icon: "🕋", bg: "rgba(64,192,87,0.12)", title: "Yakındaki Camiler", desc: "Konumunuza en yakın camileri bulun, mesafe görün ve harita ile yol tarifi alın." },
  { icon: "📚", bg: "rgba(139,92,246,0.12)", title: "Hadis Koleksiyonu", desc: "Sahih hadisler, kategori filtreleme, favori kaydetme ve günlük hadis." },
  { icon: "🧮", bg: "rgba(249,115,22,0.12)", title: "Hesaplayıcılar", desc: "Zekat, fitre ve kefaret hesaplayıcıları — güncel fiyatlar ve detaylı sonuçlar." },
];

const WHY = [
  { icon: "🔒", title: "Gizlilik Öncelikli", desc: "Verileriniz cihazınızda kalır. Reklam takibi yoktur." },
  { icon: "💎", title: "Tamamen Ücretsiz", desc: "Gizli ücretler, premium duvarları yok." },
  { icon: "🎨", title: "Modern Tasarım", desc: "Koyu tema, animasyonlar ve premium hissiyat." },
  { icon: "📱", title: "iOS Widget", desc: "Ana ekranda namaz vakitleri ve günün ayeti." },
  { icon: "🌐", title: "Çevrimdışı", desc: "Kuran, dualar, tesbih internet olmadan çalışır." },
  { icon: "⚡", title: "Hızlı & Hafif", desc: "Düşük batarya, hızlı açılma, akıcı performans." },
];
    ...
    <>
      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          <div className="hero-badge">☪ App Store&apos;da Ücretsiz</div>
          ...
          <p className="hero-trust"><span>☆ 4.9 Puan</span> · <span>100% Ücretsiz</span> · <span>Reklamsız</span> · <span>Gizlilik Öncelikli</span></p>
        </div>
      </section>
      ...
      <section className="cta-section" id="download">
        <span className="section-label">Ücretsiz İndirin</span>
