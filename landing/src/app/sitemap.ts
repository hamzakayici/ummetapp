...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/namaz-rehberi`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/dualar`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/kuran`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/tesbih`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/zekat-hesaplayici`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/hicri-takvim`, changeFrequency: "monthly", priority: 0.8 },
